# -*- encoding: utf-8 -*-
# stub: jsobfu 0.4.2 ruby lib

Gem::Specification.new do |s|
  s.name = "jsobfu".freeze
  s.version = "0.4.2".freeze

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["James Lee".freeze, "Joe Vennix".freeze]
  ...
  s.executables = ["jsobfu".freeze]
  s.files = ["bin/jsobfu".freeze]
  s.homepage = "https://github.com/rapid7/jsobfu".freeze
  s.licenses = ["BSD-3-Clause".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.0.0".freeze)
  s.rubygems_version = "3.5.10".freeze
  s.summary = "A Javascript code obfuscator".freeze

  s.installed_by_version = "3.5.10".freeze if s.respond_to? :installed_by_version

  s.specification_version = 4

  s.add_runtime_dependency(%q<rkelly-remix>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<rspec>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<simplecov>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<execjs>.freeze, [">= 0".freeze])
