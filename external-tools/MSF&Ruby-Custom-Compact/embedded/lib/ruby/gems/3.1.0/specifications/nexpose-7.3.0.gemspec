...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<codeclimate-test-reporter>.freeze, ["~> 0.4.6".freeze])
  s.add_development_dependency(%q<simplecov>.freeze, ["~> 0.9.1".freeze])
  s.add_development_dependency(%q<rake>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3.2".freeze])
  s.add_development_dependency(%q<rubocop>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<webmock>.freeze, ["~> 1.20.4".freeze])
  s.add_development_dependency(%q<vcr>.freeze, ["~> 2.9.3".freeze])
  s.add_development_dependency(%q<github_changelog_generator>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<pry>.freeze, ["= 0.9.12.6".freeze])
end
